<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	String id = (String)session.getAttribute("user_id");  //세션정보 전달.
...
<nav id="app-navbar" class="navbar navbar-inverse navbar-fixed-top primary">
  ...
  <div class="navbar-header">
    ...
    <a href="../views/dashboard.jsp" class="navbar-brand">
...
<aside id="menubar" class="menubar light">
  <div class="app-user">
    <div class="media">
      ...
      <div class="media-body">
        <div class="foldable">
          <h5><a href="javascript:void(0)" class="username"><%=id %></a></h5>
          <ul>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu animated flipInY">
                <li>
                  <a class="text-color" href="../views/logout.jsp">
    ...
    <div class="menubar-scroll-inner">
      <ul class="app-menu">
        <li class="has-submenu">
          ...
          <ul class="submenu">
            <li><a href="memberList.jsp"><span class="menu-text">회원목록</span></a></li>  
          </ul>
        </li>
      </ul><!-- .app-menu -->
