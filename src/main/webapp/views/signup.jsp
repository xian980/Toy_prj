...
<div class="simple-page-form animated flipInY" id="signup-form">
	...
	<form action="#">
		...
		<div class="form-group">
			<input id="pw" name="pw" type="password" class="form-control" placeholder="비밀번호(대,소문자,숫자 특수문자포함 6-12글자)">
		</div>
		
		<div class="form-group">
			<input type="text"  name="code" id="code" placeholder="우편번호">
		...
		<div class="form-group">
			<input id="tel" type="tel" name="tel" class="form-control" placeholder="연락처">
		</div>
